...
namespace AutocompleteMenuNS
{
    ...
    public class MulticolumnAutocompleteItem : SubstringAutocompleteItem
    {
        ...
        public MulticolumnAutocompleteItem(string[] menuTextByColumns, string insertingText, string searchingText)
        : base(insertingText, true)
        {
            this.SearchingText = searchingText.ToLower();
            this.CompareBySubstring = true;
        ...
        public override CompareResult Compare(string fragmentText)
        {
            if (SearchingText.Contains(fragmentText.ToLower()))
            {
                return CompareResult.Visible;
            }
            return CompareResult.Hidden;
